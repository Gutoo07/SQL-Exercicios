...
USE aulajoin
/*
Sintaxe SQL 2	--maior porem menos confuso
SELECT tab1.col1, tab1.col2, tab2.col1, tab3.col2
FROM tabela1 tab1 --isso eh um ALIAS sem 'AS'
INNER JOIN tabela2 tab2
ON tab1.pk = tab2.fk
INNER JOIN tabela3 tab3
ON tab2.pk = tab3.pk --aqui nos 'ON' podemos errar e acabar, por ex, colocando uma coluna q nao eh FK
WHERE condicoes
*/
/*
Sintaxe SQL 3	--menor porem mais confuso
SELECT tab1.col1, tab1.col2, tab2.col1, tab3.col2
FROM tabela1 tab1, tabela2 tab2, tabela3 tab3 --separa as tabelas por virgulas e nao usa 'INNER JOIN' nem 'ON'
WHERE tab1.pk = tab2.fk
	AND tab2.pk = tab3.fk --separamos os ON nos AND
	AND condicoes
*/
...
order by al.nome asc
--Materias sem notas cadastradas
SELECT  *
from materias mat OUTER JOIN notas nt
on mat.id = nt.id_materia
-- da erro pq precisa saber se eh a direita ou a esquerda

-- se eu quero o que esta à esquerda do outer join
SELECT  *
from materias mat LEFT OUTER JOIN notas nt
on mat.id = nt.id_materia
where nt.id_materia IS NULL -- materias que nao tem notas
--cheio de NULL
